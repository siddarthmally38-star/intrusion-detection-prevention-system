...
#### Maintainer: [Siddarth Mally](https://github.com/siddarthmally)
#### Original Author: [Hamza Khalid](https://github.com/hmzakhalid)
...
`git clone https://github.com/siddarthmally/Intrusion-Detection-Prevention-System`
...
Siddarth Mally is a Cybersecurity Analyst with over 4 years of experience in security governance, risk management, and compliance (GRC). He specializes in evaluating security controls against frameworks such as NIST CSF, ISO 27001, and NIST SP 800-53. This project is maintained as part of a commitment to exploring technical host-based security and automated threat detection.
